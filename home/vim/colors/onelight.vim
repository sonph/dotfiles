...
" Name:       onelight.vim
" Version:    1.45
" Maintainer: https://github.com/joshdick/onelight.vim/
" License:    The MIT License (MIT)
" Based On:   https://github.com/MaxSt/FlatColor/

" A companion [vim-airline](https://github.com/bling/vim-airline) theme is available at: https://github.com/joshdick/airline-onelight.vim
"
...
if !exists("g:onelight_termcolors")
  let g:onelight_termcolors = 256
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:onelight_terminal_italics")
  let g:onelight_terminal_italics = 0
endif
...
function! s:h(group, style)
  if g:onelight_terminal_italics == 0 && has_key(a:style, "cterm") && a:style["cterm"] == "italic"
    unlet a:style.cterm
  endif
  if g:onelight_termcolors == 16
...
call s:h("IncSearch", { "fg": s:white, "bg": s:yellow })
...
call s:h("Normal", { "fg": s:black, "bg": s:white}) " normal text
call s:h("Pmenu", { "fg": s:white, "bg": s:black }) " Popup menu: normal item.
call s:h("PmenuSel", { "fg": s:white, "bg": s:blue }) " Popup menu: selected item.
call s:h("PmenuSbar", { "bg": s:visual_grey }) " Popup menu: scrollbar.
call s:h("PmenuThumb", { "bg": s:white }) " Popup menu: Thumb of the scrollbar.
call s:h("Question", { "fg": s:purple }) " hit-enter prompt and yes/no questions
call s:h("Search", { "fg": s:white, "bg": s:yellow }) " Last search pattern highlighting (see 'hlsearch'). Also used for highlighting the current line in the quickfix window and similar items that need to stand out.
...
call s:h("StatusLineNC", { "fg": s:comment_grey, "bg": s:special_grey }) " status lines of not-current windows Note: if this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
call s:h("TabLine", { "fg": s:comment_grey, "bg": s:cursor_grey }) " tab pages line, not active tab page label
call s:h("TabLineFill", { "bg": s:cursor_grey }) " tab pages line, where there are no labels
call s:h("TabLineSel", { "fg": s:black, "bg": s:white}) " tab pages line, active tab page label
