" Color palette
let s:gui_dark_gray = '#282c34'
let s:cterm_dark_gray = 236
let s:gui_med_gray_hi = '#3b4451'
let s:cterm_med_gray_hi = 238
let s:gui_med_gray_lo = '#566274'
let s:cterm_med_gray_lo = 241
let s:gui_light_gray = '#a8b2bf'
let s:cterm_light_gray = 249
let s:gui_green = '#afd787'
let s:cterm_green = 150
let s:gui_blue = '#61afef'
let s:cterm_blue = 039
let s:gui_purple = '#c678dd'
let s:cterm_purple = 176
let s:gui_orange = '#e5c07b'
let s:cterm_orange = 180
let s:gui_red = '#e06c75'
let s:cterm_red = 168
...
let g:airline#themes#onedark#palette.insert = airline#themes#generate_color_map(s:I1, s:N2, s:I3)
let g:airline#themes#onedark#palette.insert_modified = copy(g:airline#themes#onedark#palette.normal_modified)
let g:airline#themes#onedark#palette.insert_paste = {
...
let g:airline#themes#onedark#palette.replace = {
      ...
      \ }
let g:airline#themes#onedark#palette.replace_modified = copy(g:airline#themes#onedark#palette.insert_modified)

" Visual mode
let s:V1 = [s:gui_dark_gray, s:gui_orange, s:cterm_dark_gray, s:cterm_orange]
let s:V3 = [s:gui_orange, s:gui_med_gray_hi, s:cterm_pink, s:cterm_med_gray_hi]
let g:airline#themes#onedark#palette.visual = airline#themes#generate_color_map(s:V1, s:N2, s:V3)
let g:airline#themes#onedark#palette.visual_modified = copy(g:airline#themes#onedark#palette.insert_modified)

" Inactive window
let s:IA = [s:gui_light_gray, s:gui_med_gray_hi, s:cterm_light_gray, s:cterm_med_gray_hi, '']
let g:airline#themes#onedark#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
...
let g:airline#themes#onedark#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
